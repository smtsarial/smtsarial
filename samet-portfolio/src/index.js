  ...
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, pointerEvents: 'none', width: '100%', height: '100vh' }}>
      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate3d(-50%,-50%,0)' }}>
        <h1 style={{ margin: 0, padding: 0, fontSize: isMobile ? '5em' : '15em', fontWeight: 900, letterSpacing: '-0.05em', 'textAlign': 'center' }}>SAMET SARIAL</h1>

        <div style={{ margin: 0, padding: 0, fontWeight: 700, letterSpacing: '-0.05em', 'textAlign': 'center' }}>
          <div style={{ fontSize: isMobile ? '18px' : '25px', fontWeight: 700 }}>Software Engineer</div>
          <div style={{ fontSize: isMobile ? '13px' : '18px', fontWeight: 500 }}>I build accessible, inclusive products and digital experiences for the web and mobile.</div>
        </div>

        <div className='flex justify-center'>
          <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
            <li className="mr-5 text-xs">
              <a className="block hover:text-slate-200" href="https://github.com/smtsarial" target="_blank" rel="noreferrer">
            ...
            <li className="mr-5 text-xs">
              <a className="block hover:text-slate-200" href="https://instagram.com/smtsarial" target="_blank" rel="noreferrer">
            ...
            <li className="mr-5 text-xs">
              <a className="block hover:text-slate-200" href="https://twitter.com/smtsarial" target="_blank" rel="noreferrer">
            ...
            <li className="mr-5 text-xs">
              <a className="block hover:text-slate-200" href="https://www.linkedin.com/in/smtsarial/" target="_blank" rel="noreferrer">
      ...
      <div style={{ position: 'absolute', top: 40, left: 40, fontSize: '13px' }}>
        <div>
          <a href="mailto:sarialsamet@gmail.com" target="_blank" rel="noreferrer"> Contact Me</a>
        </div>
      </div>
      <div style={{ position: 'absolute', bottom: 40, right: 40, fontSize: '13px' }}>06/08/2023</div>
    </div>
  )
}
